# https://github.com/scz10/klikbca-scraper.git
# MIT License
# v1.1 using Klikbca web instead klikbca mobile version
# on Dec 20, 2021
# Jakarta,Indonesia cahyamulyadi@outlook.com
...
class KlikBCAParser:
    ...
    def login(self):
        ...
        self.s.post(url=self.url['login_url'], headers=self.headers, data=payloads, verify=False)
        ...
        try:
            ...
            for row in rows:
                ...
                if first:
                    ...
                    col_data.append([ele.get_text(separator="\n").strip() for ele in cols])
